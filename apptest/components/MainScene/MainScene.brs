...
sub setChannel()
	...
	content.streamFormat = "m3u, m3u8, hls, mp4, mkv, mp3, avi, m4v, ts, mpeg-4, flv, vob, ogg, ogv, webm, mov, wmv, asf, amv, mpg, mp2, mpeg, mpe, mpv, mpeg2"
...
sub showdialog()
    ...
    keyboarddialog.title = "Ingresa tu lista M3U"

    keyboarddialog.buttons=["OK", "Guardar"]
...
sub onKeyPress()
    ...
    else if m.top.dialog.buttonSelected = 1 ' Guardar
